...
const kaynaklar = {
  ...
  arkeofiliDendera: source("arkeofiliDendera", {
  ...
  arkeofiliSfenks: source("arkeofiliSfenks", {
    tier: "institutional", type: "webpage",
  ...
  arkeofiliRadar: source("arkeofiliRadar", {
    tier: "institutional", type: "webpage",
  ...
  arkeofiliSiluriyen: source("arkeofiliSiluriyen", {
    tier: "institutional", type: "webpage",
...
const kayitlar = [
  finding({
    ...
    period: { earliest: -54, latest: 20, era_label: "Ptolemaios-Roma dönemi tapınağı", precision: "consensus", dating_method: ["historical-record", "inscription"] },
    languages: ["Türkçe", "Mısırca"],
    disciplines: ["misirbilim", "ikonografi"],
    ...
    divergence_type: ["kategori-hatasi", "yeniden-adlandirma"],
    sources: [dunn1998, cauville2020, arkeofiliDendera],
    evidence: [
      ev("Kabartma, Hathor tapınağının mahzenlerinde yer alır; tapınak MÖ 54'te başlayan inşaatıyla Ptolemaios dönemine aittir.", cite("arkeofiliDendera", "Tapınak tarihi bölümü", "context")),
  ...
  finding({
    ...
    disciplines: ["arkeoloji", "arkeometri"],
  ...
  finding({
    ...
    period: { earliest: -2589, latest: -2566, era_label: "IV. Hanedan, Keops dönemi", precision: "consensus", dating_method: ["historical-record", "inscription", "radiocarbon"] },
    languages: ["Türkçe", "İngilizce"],
    disciplines: ["misirbilim", "muhendislik"],
  ...
  finding({
    ...
    period: { earliest: -2589, latest: -2566, era_label: "IV. Hanedan", precision: "consensus", dating_method: ["historical-record"] },
    languages: ["Türkçe", "İngilizce"],
  ...
  finding({
    ...
    languages: ["Türkçe", "İngilizce"],
    disciplines: ["jeoloji", "misirbilim"],
    ...
    counter_evidence: [
      ...
      ev("2023'te yayımlanan akışkan deneyleri, doğal süreçlerin Sfenks benzeri biçimler üretebildiğini gösterdi; tartışma canlı ama ana akım tezi benimsemiyor.", cite("arkeofiliSfenks", "Deney haberi", "context")),
    ],
  ...
  finding({
    ...
    languages: ["Türkçe", "İngilizce"],
    disciplines: ["arkeoloji", "jeofizik"],
    ...
    divergence_type: ["kanit-siniri", "dongusel-anlati"],
    ...
    counter_evidence: [
      ev("Anomaliler bağımsız biçimde 'yapı' olarak doğrulanmadı; kireçtaşındaki doğal boşluk ve çatlaklar bu sinyalleri üretebilir.", cite("arkeofiliRadar", "Radar iddialarının kuşkucu değerlendirmesi", "counter")),
      ...
      ev("Mısır Eski Eserler Bakanlığı'nın açıklamaları ve sonraki taramalar oda bildirmemiştir.", cite("arkeofiliRadar", "Resmî açıklama bölümü", "counter")),
    ],
  ...
  finding({
    ...
    subject: { site: "Büyük Sfenks", region: "Giza", modern_country: "Mısır", coordinates: { lat: 29.9753, lon: 31.1376 } },
    period: { earliest: 1378, latest: 1798, era_label: "1378 olayı - 1798 Napoleon seferi", precision: "consensus", dating_method: ["historical-record"] },
    ...
    divergence_type: ["kaynak-karismasi"],
  ...
  finding({
    ...
    divergence_type: ["secici-eslestirme"],
  ...
  finding({
    ...
    period: { earliest: -3200, latest: 30, era_label: "Firavun dönemi bütünü", precision: "consensus", dating_method: ["historical-record"] },
    languages: ["Türkçe", "İngilizce"],
    disciplines: ["arkeoloji", "bilim-felsefesi"],
    ...
    divergence_type: ["kanit-siniri", "kategori-hatasi"],
    ...
    counter_evidence: [
      ...
      ev("'Kayıp ileri uygarlık' kalıbı, arkeolojik yöntemin dışındaki bir hipotez ailesidir; jeolojik izi sorgulanan Silüriyen hipotezi tartışması bunun güncel örneğidir.", cite("arkeofiliSiluriyen", "Hipotez değerlendirmesi", "context")),
  ...
  finding({
    ...
    period: { earliest: -1401, latest: -1391, era_label: "IV. Thutmose dönemi", precision: "consensus", dating_method: ["historical-record", "inscription"] },
    languages: ["Türkçe", "Mısırca"],
    disciplines: ["misirbilim", "tarih"],
    popular_claim: "—",
    divergence: "—",
    divergence_type: [],
