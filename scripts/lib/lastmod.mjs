...
const IZLENEN = ["articles", "dist", "index.html", "pages", "assets", "data/articles.json", "data/reading-pilot.json", "data/arama-sorulari.json", "data/konu-merkezleri.json", "data/tartisma-pilotu.json", "data/bulten.json"];
