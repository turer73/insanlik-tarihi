...
| Durum | Sayı | Ne demek |
|---|---:|---|
| Sağlam | 247 | Yanıt verdi: düz adreste 2xx, tanımlayıcıda 2xx ya da 30x |
| Yönlendi | 0 | 2xx döndü ama adres değişti; künyedeki adres eskimiş olabilir |
| Engelli | 32 | 401/403/405/406/429/451 — yayıncı betik isteklerini kapatıyor. **Ölü değil**, tarayıcıda açılır |
| Ölü | 0 | 4xx/5xx — gerçekten kırık, düzeltilmeli |
| Ulaşılamadı | 1 | Bağlantı kurulamadı ya da zaman aşımı |
...
|---|---|---|---|
| Sumerian King List | primary | [bağlantı](https://cdli.earth/artifacts/112355) | zaman aşımı |


## Betiğe kapalı olanlar (32)
...
| Late Uruk cylinder seal 116722 | primary | [bağlantı](https://www.britishmuseum.org/collection/object/W_1925-0110-20) | 403 |
| How to write cuneiform | institutional | [bağlantı](https://www.britishmuseum.org/blog/how-write-cuneiform) | 403 |
| Bevelled rim bowl | institutional | [bağlantı](https://www.britishmuseum.org/collection/object/W_1932-1212-1279) | 403 |
...
| Magnetometry at Uruk (Iraq): The city of King Gilgamesh | institutional | [bağlantı](https://ui.adsabs.harvard.edu/abs/2003EAEJA.....9152F/abstract) | 405 |
...
| Gilgamesh/Gilgamesh Epic | peer-reviewed | [bağlantı](https://doi.org/10.1093/acrefore/9780199381135.013.9025) | 403 |
...
| Holocene fluvial and anthropogenic processes in the region of Uruk in southern M | peer-reviewed | [bağlantı](https://discovery.ucl.ac.uk/id/eprint/10039203/) | 403 |
| Gilgamesh | institutional | [bağlantı](https://www.metmuseum.org/essays/gilgamesh) | 429 |
...
| The Uruk Phenomenon | peer-reviewed | [bağlantı](https://doi.org/10.1093/oso/9780190687854.003.0004) | 403 |
| White Temple and ziggurat, Uruk | institutional | [bağlantı](https://smarthistory.org/white-temple-and-ziggurat-uruk/) | 403 |
| Warka Vase | institutional | [bağlantı](https://smarthistory.org/warka-vase/) | 403 |
...
| The Ahwar of Southern Iraq | institutional | [bağlantı](https://whc.unesco.org/en/list/1481/) | 403 |
...
| The Spatial Dimensions of Early Mesopotamian Urbanism: The Tell Brak Suburban Su | peer-reviewed | [bağlantı](https://jasonur.scholars.harvard.edu/publications/spatial-dimensions-early-mesopotamian-urbanism-tell-brak-suburban-survey-2003-2) | 403 |
