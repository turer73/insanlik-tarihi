(() => {
  ...
  function imageSource(slug) {
    return window.ITCoverData?.[slug] || `${assetPrefix()}covers/${encodeURIComponent(slug)}.webp`;
  }
  ...
  function addImageLoadState() {
    document.addEventListener('error', event => {
      ...
      image.closest('.it-story-visual__frame, .it-section-visual__frame')?.classList.add('is-image-missing');
    }, true);
  }
